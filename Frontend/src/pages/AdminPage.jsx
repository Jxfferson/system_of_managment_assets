      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-3">
            <Button onClick={handleAdd} className="h-10 px-7 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-semibold rounded-xl shadow-lg shadow-cyan-500/25 transition-all hover:scale-105">
        ...
        {showForm && (
          ...
          >
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <Button onClick={handleSave} className="h-9 px-8 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-semibold rounded-xl shadow-lg shadow-cyan-500/25 transition-all hover:scale-105">
